...
To update the database use this command from the Web project folder (replace `Leuze_AGV_Handling_Service` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../Leuze_AGV_Handling_Service.Infrastructure/Leuze_AGV_Handling_Service.Infrastructure.csproj -s Leuze_AGV_Handling_Service.Web.csproj
```
