...
namespace Handling_Service.Core.Ros2.Interfaces.Sensor
{
    ...
    public unsafe partial class PointCloud2 : global::Rosidl.Runtime.IMessage
    {
        ...
        public PointCloud2(
            ...
            uint @height = 0,
            uint @width = 0,
            global::Handling_Service.Core.Ros2.Interfaces.Sensor.PointField[]? @fields = null,
        ...
        )
        {
            ...
            Height = @height;
            Width = @width;
            Fields = @fields ?? global::System.Array.Empty<global::Handling_Service.Core.Ros2.Interfaces.Sensor.PointField>();
        ...
        public PointCloud2(in Priv priv, global::System.Text.Encoding textEncoding)
        {
            ...
            this.Fields = new global::Handling_Service.Core.Ros2.Interfaces.Sensor.PointField[priv.Fields.Size];
            var Fields_span = priv.Fields.AsSpan();
            for (int __i = 0; __i < this.Fields.Length; __i++)
            {
                this.Fields[__i] = new global::Handling_Service.Core.Ros2.Interfaces.Sensor.PointField(in Fields_span[__i], textEncoding);
            }
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        public global::Handling_Service.Core.Ros2.Interfaces.Sensor.PointField[] Fields { get; set; }
        ...
        public void WriteTo(ref Priv priv, global::System.Text.Encoding textEncoding)
        {
            ...
            priv.Fields = new global::Handling_Service.Core.Ros2.Interfaces.Sensor.PointField.PrivSequence(this.Fields.Length);
            var Fields_span = priv.Fields.AsSpan();
            for (int __i = 0; __i < this.Fields.Length; __i++)
            {
        ...
        public partial struct Priv : global::System.IEquatable<Priv>, global::System.IDisposable
        {
            ...
            /// Originally defined as: <c><![CDATA[sensor_msgs/msg/PointField[] fields]]></c>
            /// </remarks>
            public global::Handling_Service.Core.Ros2.Interfaces.Sensor.PointField.PrivSequence Fields;
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::Handling_Service.Core.Ros2.Interfaces.Sensor.PointCloud2.Priv.{caller}'.");
                }
            }
        }
        ...
        public partial struct PrivSequence : global::System.IEquatable<PrivSequence>, global::System.IDisposable
        {
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::Handling_Service.Core.Ros2.Interfaces.Sensor.PointCloud2.PrivSequence.{caller}'.");
                }
            }
        }
    }
