...
namespace Handling_Service.Core.Ros2.Interfaces.Diagnostic
{
    ...
    public unsafe partial class DiagnosticStatus : global::Rosidl.Runtime.IMessage
    {
        ...
        public DiagnosticStatus(
            ...
            string @message = "",
            string @hardwareId = "",
            global::Handling_Service.Core.Ros2.Interfaces.Diagnostic.KeyValue[]? @values = null
        )
        {
            Level = @level;
            Name = @name;
            ...
            Values = @values ?? global::System.Array.Empty<global::Handling_Service.Core.Ros2.Interfaces.Diagnostic.KeyValue>();
        }
        ...
        public DiagnosticStatus(in Priv priv, global::System.Text.Encoding textEncoding)
        {
            ...
            this.Values = new global::Handling_Service.Core.Ros2.Interfaces.Diagnostic.KeyValue[priv.Values.Size];
            var Values_span = priv.Values.AsSpan();
            for (int __i = 0; __i < this.Values.Length; __i++)
            {
                this.Values[__i] = new global::Handling_Service.Core.Ros2.Interfaces.Diagnostic.KeyValue(in Values_span[__i], textEncoding);
            }
        }
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        public global::Handling_Service.Core.Ros2.Interfaces.Diagnostic.KeyValue[] Values { get; set; }
        ...
        public void WriteTo(ref Priv priv, global::System.Text.Encoding textEncoding)
        {
            ...
            priv.Values = new global::Handling_Service.Core.Ros2.Interfaces.Diagnostic.KeyValue.PrivSequence(this.Values.Length);
            var Values_span = priv.Values.AsSpan();
            for (int __i = 0; __i < this.Values.Length; __i++)
            {
        ...
        public partial struct Priv : global::System.IEquatable<Priv>, global::System.IDisposable
        {
            ...
            /// Originally defined as: <c><![CDATA[diagnostic_msgs/msg/KeyValue[] values]]></c>
            /// </remarks>
            public global::Handling_Service.Core.Ros2.Interfaces.Diagnostic.KeyValue.PrivSequence Values;
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::Handling_Service.Core.Ros2.Interfaces.Diagnostic.DiagnosticStatus.Priv.{caller}'.");
                }
            }
        }
        ...
        public partial struct PrivSequence : global::System.IEquatable<PrivSequence>, global::System.IDisposable
        {
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::Handling_Service.Core.Ros2.Interfaces.Diagnostic.DiagnosticStatus.PrivSequence.{caller}'.");
                }
            }
        }
    }
