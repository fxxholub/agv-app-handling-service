...
namespace Handling_Service.Core.Ros2.Interfaces.Geometry
{
    ...
    public unsafe partial class PoseArray : global::Rosidl.Runtime.IMessage
    {
        ...
        public PoseArray(
            ...
            global::Handling_Service.Core.Ros2.Interfaces.Geometry.Pose[]? @poses = null
        )
        {
            Header = @header ?? new global::Handling_Service.Core.Ros2.Interfaces.Std.Header();
            Poses = @poses ?? global::System.Array.Empty<global::Handling_Service.Core.Ros2.Interfaces.Geometry.Pose>();
        }
        ...
        public PoseArray(in Priv priv, global::System.Text.Encoding textEncoding)
        {
            ...
            this.Poses = new global::Handling_Service.Core.Ros2.Interfaces.Geometry.Pose[priv.Poses.Size];
            var Poses_span = priv.Poses.AsSpan();
            for (int __i = 0; __i < this.Poses.Length; __i++)
            {
                this.Poses[__i] = new global::Handling_Service.Core.Ros2.Interfaces.Geometry.Pose(in Poses_span[__i], textEncoding);
            }
        }
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        public global::Handling_Service.Core.Ros2.Interfaces.Geometry.Pose[] Poses { get; set; }
        ...
        public void WriteTo(ref Priv priv, global::System.Text.Encoding textEncoding)
        {
            ...
            priv.Poses = new global::Handling_Service.Core.Ros2.Interfaces.Geometry.Pose.PrivSequence(this.Poses.Length);
            var Poses_span = priv.Poses.AsSpan();
            for (int __i = 0; __i < this.Poses.Length; __i++)
            {
        ...
        public partial struct Priv : global::System.IEquatable<Priv>, global::System.IDisposable
        {
            ...
            /// Originally defined as: <c><![CDATA[geometry_msgs/msg/Pose[] poses]]></c>
            /// </summary>
            public global::Handling_Service.Core.Ros2.Interfaces.Geometry.Pose.PrivSequence Poses;
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::Handling_Service.Core.Ros2.Interfaces.Geometry.PoseArray.Priv.{caller}'.");
                }
            }
        }
        ...
        public partial struct PrivSequence : global::System.IEquatable<PrivSequence>, global::System.IDisposable
        {
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::Handling_Service.Core.Ros2.Interfaces.Geometry.PoseArray.PrivSequence.{caller}'.");
                }
            }
        }
    }
