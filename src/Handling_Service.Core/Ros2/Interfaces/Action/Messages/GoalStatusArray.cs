...
namespace Handling_Service.Core.Ros2.Interfaces.Action
{
    ...
    public unsafe partial class GoalStatusArray : global::Rosidl.Runtime.IMessage
    {
        ...
        public GoalStatusArray(
            global::Handling_Service.Core.Ros2.Interfaces.Action.GoalStatus[]? @statusList = null
        )
        {
            StatusList = @statusList ?? global::System.Array.Empty<global::Handling_Service.Core.Ros2.Interfaces.Action.GoalStatus>();
        }
        ...
        {
            this.StatusList = new global::Handling_Service.Core.Ros2.Interfaces.Action.GoalStatus[priv.StatusList.Size];
            var StatusList_span = priv.StatusList.AsSpan();
            for (int __i = 0; __i < this.StatusList.Length; __i++)
            {
                this.StatusList[__i] = new global::Handling_Service.Core.Ros2.Interfaces.Action.GoalStatus(in StatusList_span[__i], textEncoding);
            }
        }
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        public global::Handling_Service.Core.Ros2.Interfaces.Action.GoalStatus[] StatusList { get; set; }
        ...
        {
            priv.StatusList = new global::Handling_Service.Core.Ros2.Interfaces.Action.GoalStatus.PrivSequence(this.StatusList.Length);
            var StatusList_span = priv.StatusList.AsSpan();
            for (int __i = 0; __i < this.StatusList.Length; __i++)
            {
        ...
        public partial struct Priv : global::System.IEquatable<Priv>, global::System.IDisposable
        {
            ...
            /// Originally defined as: <c><![CDATA[action_msgs/msg/GoalStatus[] status_list]]></c>
            /// </remarks>
            public global::Handling_Service.Core.Ros2.Interfaces.Action.GoalStatus.PrivSequence StatusList;
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::Handling_Service.Core.Ros2.Interfaces.Action.GoalStatusArray.Priv.{caller}'.");
                }
            }
        }
        ...
        public partial struct PrivSequence : global::System.IEquatable<PrivSequence>, global::System.IDisposable
        {
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::Handling_Service.Core.Ros2.Interfaces.Action.GoalStatusArray.PrivSequence.{caller}'.");
                }
            }
        }
    }
