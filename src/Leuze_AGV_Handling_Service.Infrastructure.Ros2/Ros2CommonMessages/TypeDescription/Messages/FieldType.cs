    ...
    public unsafe partial class FieldType : global::Rosidl.Runtime.IMessage
    {
        ...
        public partial struct Priv : global::System.IEquatable<Priv>, global::System.IDisposable
        {
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::Leuze_AGV_Handling_Service.Infrastructure.Ros2.Ros2CommonMessages.TypeDescription.FieldType.Priv.{caller}'.");
                }
            }
        }
        ...
        public partial struct PrivSequence : global::System.IEquatable<PrivSequence>, global::System.IDisposable
        {
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::Leuze_AGV_Handling_Service.Infrastructure.Ros2.Ros2CommonMessages.TypeDescription.FieldType.PrivSequence.{caller}'.");
                }
            }
        }
    }
