...
namespace Handling_Service.Core.Ros2.Interfaces.Nav
{
    ...
    public unsafe partial class GridCells : global::Rosidl.Runtime.IMessage
    {
        ...
        public GridCells(
            ...
            float @cellWidth = 0f,
            float @cellHeight = 0f,
            global::Handling_Service.Core.Ros2.Interfaces.Geometry.Point[]? @cells = null
        )
        {
            Header = @header ?? new global::Handling_Service.Core.Ros2.Interfaces.Std.Header();
            CellWidth = @cellWidth;
            CellHeight = @cellHeight;
            Cells = @cells ?? global::System.Array.Empty<global::Handling_Service.Core.Ros2.Interfaces.Geometry.Point>();
        }
        ...
        public GridCells(in Priv priv, global::System.Text.Encoding textEncoding)
        {
            ...
            this.Cells = new global::Handling_Service.Core.Ros2.Interfaces.Geometry.Point[priv.Cells.Size];
            var Cells_span = priv.Cells.AsSpan();
            for (int __i = 0; __i < this.Cells.Length; __i++)
            {
                this.Cells[__i] = new global::Handling_Service.Core.Ros2.Interfaces.Geometry.Point(in Cells_span[__i], textEncoding);
            }
        }
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        public global::Handling_Service.Core.Ros2.Interfaces.Geometry.Point[] Cells { get; set; }
        ...
        public void WriteTo(ref Priv priv, global::System.Text.Encoding textEncoding)
        {
            ...
            priv.Cells = new global::Handling_Service.Core.Ros2.Interfaces.Geometry.Point.PrivSequence(this.Cells.Length);
            var Cells_span = priv.Cells.AsSpan();
            for (int __i = 0; __i < this.Cells.Length; __i++)
            {
        ...
        public partial struct Priv : global::System.IEquatable<Priv>, global::System.IDisposable
        {
            ...
            /// Originally defined as: <c><![CDATA[geometry_msgs/msg/Point[] cells]]></c>
            /// </remarks>
            public global::Handling_Service.Core.Ros2.Interfaces.Geometry.Point.PrivSequence Cells;
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::Handling_Service.Core.Ros2.Interfaces.Nav.GridCells.Priv.{caller}'.");
                }
            }
        }
        ...
        public partial struct PrivSequence : global::System.IEquatable<PrivSequence>, global::System.IDisposable
        {
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::Handling_Service.Core.Ros2.Interfaces.Nav.GridCells.PrivSequence.{caller}'.");
                }
            }
        }
    }
