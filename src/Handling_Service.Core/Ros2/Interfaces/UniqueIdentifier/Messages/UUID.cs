...
namespace Handling_Service.Core.Ros2.Interfaces.UniqueIdentifier
{
    /// <summary>
    ...
    public unsafe partial class UUID : global::Rosidl.Runtime.IMessage
    {
        ...
        public partial struct Priv : global::System.IEquatable<Priv>, global::System.IDisposable
        {
            ...
            public global::System.Span<byte> Uuid
            {
                get
                {
                    fixed (global::Handling_Service.Core.Ros2.Interfaces.UniqueIdentifier.UUID.Priv* __p = &this) return new (__p->__Uuid, 16);
                }
            }
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::Handling_Service.Core.Ros2.Interfaces.UniqueIdentifier.UUID.Priv.{caller}'.");
                }
            }
        }
        ...
        public partial struct PrivSequence : global::System.IEquatable<PrivSequence>, global::System.IDisposable
        {
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::Handling_Service.Core.Ros2.Interfaces.UniqueIdentifier.UUID.PrivSequence.{caller}'.");
                }
            }
        }
    }
