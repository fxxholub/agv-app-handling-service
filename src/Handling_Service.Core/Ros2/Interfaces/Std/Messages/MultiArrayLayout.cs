...
namespace Handling_Service.Core.Ros2.Interfaces.Std
{
    ...
    public unsafe partial class MultiArrayLayout : global::Rosidl.Runtime.IMessage
    {
        ...
        public MultiArrayLayout(
            global::Handling_Service.Core.Ros2.Interfaces.Std.MultiArrayDimension[]? @dim = null,
            uint @dataOffset = 0
        )
        {
            Dim = @dim ?? global::System.Array.Empty<global::Handling_Service.Core.Ros2.Interfaces.Std.MultiArrayDimension>();
        ...
        {
            this.Dim = new global::Handling_Service.Core.Ros2.Interfaces.Std.MultiArrayDimension[priv.Dim.Size];
            var Dim_span = priv.Dim.AsSpan();
            for (int __i = 0; __i < this.Dim.Length; __i++)
            {
                this.Dim[__i] = new global::Handling_Service.Core.Ros2.Interfaces.Std.MultiArrayDimension(in Dim_span[__i], textEncoding);
            }
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        public global::Handling_Service.Core.Ros2.Interfaces.Std.MultiArrayDimension[] Dim { get; set; }
        ...
        {
            priv.Dim = new global::Handling_Service.Core.Ros2.Interfaces.Std.MultiArrayDimension.PrivSequence(this.Dim.Length);
            var Dim_span = priv.Dim.AsSpan();
            for (int __i = 0; __i < this.Dim.Length; __i++)
            {
        ...
        public partial struct Priv : global::System.IEquatable<Priv>, global::System.IDisposable
        {
            ...
            /// Originally defined as: <c><![CDATA[std_msgs/msg/MultiArrayDimension[] dim]]></c>
            /// </remarks>
            public global::Handling_Service.Core.Ros2.Interfaces.Std.MultiArrayDimension.PrivSequence Dim;
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::Handling_Service.Core.Ros2.Interfaces.Std.MultiArrayLayout.Priv.{caller}'.");
                }
            }
        }
        ...
        public partial struct PrivSequence : global::System.IEquatable<PrivSequence>, global::System.IDisposable
        {
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::Handling_Service.Core.Ros2.Interfaces.Std.MultiArrayLayout.PrivSequence.{caller}'.");
                }
            }
        }
    }
