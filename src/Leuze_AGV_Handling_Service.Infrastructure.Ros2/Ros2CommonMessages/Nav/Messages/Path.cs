...
namespace Leuze_AGV_Handling_Service.Infrastructure.Ros2.Ros2CommonMessages.Nav
{
    ...
    public unsafe partial class Path : global::Rosidl.Runtime.IMessage
    {
        ...
        public Path(
            ...
            global::Leuze_AGV_Handling_Service.Infrastructure.Ros2.Ros2CommonMessages.Geometry.PoseStamped[]? @poses = null
        )
        {
            Header = @header ?? new global::Leuze_AGV_Handling_Service.Infrastructure.Ros2.Ros2CommonMessages.Std.Header();
            Poses = @poses ?? global::System.Array.Empty<global::Leuze_AGV_Handling_Service.Infrastructure.Ros2.Ros2CommonMessages.Geometry.PoseStamped>();
        }
        ...
        public Path(in Priv priv, global::System.Text.Encoding textEncoding)
        {
            ...
            this.Poses = new global::Leuze_AGV_Handling_Service.Infrastructure.Ros2.Ros2CommonMessages.Geometry.PoseStamped[priv.Poses.Size];
            var Poses_span = priv.Poses.AsSpan();
            for (int __i = 0; __i < this.Poses.Length; __i++)
            {
                this.Poses[__i] = new global::Leuze_AGV_Handling_Service.Infrastructure.Ros2.Ros2CommonMessages.Geometry.PoseStamped(in Poses_span[__i], textEncoding);
            }
        }
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        public global::Leuze_AGV_Handling_Service.Infrastructure.Ros2.Ros2CommonMessages.Geometry.PoseStamped[] Poses { get; set; }
        ...
        public void WriteTo(ref Priv priv, global::System.Text.Encoding textEncoding)
        {
            ...
            priv.Poses = new global::Leuze_AGV_Handling_Service.Infrastructure.Ros2.Ros2CommonMessages.Geometry.PoseStamped.PrivSequence(this.Poses.Length);
            var Poses_span = priv.Poses.AsSpan();
            for (int __i = 0; __i < this.Poses.Length; __i++)
            {
        ...
        public partial struct Priv : global::System.IEquatable<Priv>, global::System.IDisposable
        {
            ...
            /// Originally defined as: <c><![CDATA[geometry_msgs/msg/PoseStamped[] poses]]></c>
            /// </remarks>
            public global::Leuze_AGV_Handling_Service.Infrastructure.Ros2.Ros2CommonMessages.Geometry.PoseStamped.PrivSequence Poses;
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::Leuze_AGV_Handling_Service.Infrastructure.Ros2.Ros2CommonMessages.Nav.Path.Priv.{caller}'.");
                }
            }
        }
        ...
        public partial struct PrivSequence : global::System.IEquatable<PrivSequence>, global::System.IDisposable
        {
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::Leuze_AGV_Handling_Service.Infrastructure.Ros2.Ros2CommonMessages.Nav.Path.PrivSequence.{caller}'.");
                }
            }
        }
    }
