...
namespace Leuze_AGV_Handling_Service.Infrastructure.Ros2.Ros2CommonMessages.Action
{
    ...
    public unsafe partial class GoalStatusArray : global::Rosidl.Runtime.IMessage
    {
        ...
        /// An array of goal statuses.
        /// <para>(originally defined as: <c><![CDATA[action_msgs/msg/GoalStatus[] status_list]]></c>)</para>
        /// </param>
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        public GoalStatusArray(
            global::Leuze_AGV_Handling_Service.Infrastructure.Ros2.Ros2CommonMessages.Action.GoalStatus[]? @statusList = null
        )
        {
            StatusList = @statusList ?? global::System.Array.Empty<global::Leuze_AGV_Handling_Service.Infrastructure.Ros2.Ros2CommonMessages.Action.GoalStatus>();
        }
        ...
        {
            this.StatusList = new global::Leuze_AGV_Handling_Service.Infrastructure.Ros2.Ros2CommonMessages.Action.GoalStatus[priv.StatusList.Size];
            var StatusList_span = priv.StatusList.AsSpan();
            for (int __i = 0; __i < this.StatusList.Length; __i++)
            {
                this.StatusList[__i] = new global::Leuze_AGV_Handling_Service.Infrastructure.Ros2.Ros2CommonMessages.Action.GoalStatus(in StatusList_span[__i], textEncoding);
            }
        }
        ...
        /// </summary>
        /// <remarks>
        /// Originally defined as: <c><![CDATA[action_msgs/msg/GoalStatus[] status_list]]></c>
        /// </remarks>
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        public global::Leuze_AGV_Handling_Service.Infrastructure.Ros2.Ros2CommonMessages.Action.GoalStatus[] StatusList { get; set; }
        ...
        {
            priv.StatusList = new global::Leuze_AGV_Handling_Service.Infrastructure.Ros2.Ros2CommonMessages.Action.GoalStatus.PrivSequence(this.StatusList.Length);
            var StatusList_span = priv.StatusList.AsSpan();
            for (int __i = 0; __i < this.StatusList.Length; __i++)
            {
        ...
        public partial struct Priv : global::System.IEquatable<Priv>, global::System.IDisposable
        {
            ...
            /// Originally defined as: <c><![CDATA[action_msgs/msg/GoalStatus[] status_list]]></c>
            /// </remarks>
            public global::Leuze_AGV_Handling_Service.Infrastructure.Ros2.Ros2CommonMessages.Action.GoalStatus.PrivSequence StatusList;
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::Leuze_AGV_Handling_Service.Infrastructure.Ros2.Ros2CommonMessages.Action.GoalStatusArray.Priv.{caller}'.");
                }
            }
        }
        ...
        public partial struct PrivSequence : global::System.IEquatable<PrivSequence>, global::System.IDisposable
        {
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::Leuze_AGV_Handling_Service.Infrastructure.Ros2.Ros2CommonMessages.Action.GoalStatusArray.PrivSequence.{caller}'.");
                }
            }
        }
    }
