...
public class ProcessConfig
{
    ...
    public List<ProcessC> Mapping { get; set; } = new(); // secondary process - asignable to all the previous processes
    ...
    public void Validate()
    {
        ...
        if (Mapping == null) throw new InvalidOperationException("Mapping processes cannot be null.");
        ...
        foreach (var process in Mapping)
        {
            process.Validate();
        }
    }
